...
INSERT INTO account_types (id, name, normal_id, nominal) VALUES (1, 'Assets', 0, 0); --debit normal
	INSERT INTO account_types (id, parent_id, name) VALUES (11, 1, 'Tangible Assets');
		...
		INSERT INTO account_types (id, parent_id, name, normal_id, contra) VALUES (113, 11, 'Accumulated Depreciation', 0, 1); --debit normal but contra (always has a negative or zero balance)
			INSERT INTO account_types (id, parent_id, name, normal_id, contra) VALUES (1131, 113, 'Section 179 Accumulated Depreciation', 0, 1); -- section 179
		INSERT INTO account_types (id, parent_id, name, normal_id, contra) VALUES (114, 11, 'Accumulated Amortization', 0, 1); -- section 197 intangibles, spread over 15 years
